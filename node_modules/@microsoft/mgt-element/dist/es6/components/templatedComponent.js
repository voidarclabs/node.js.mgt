...
export class MgtTemplatedComponent extends MgtBaseComponent {
    ...
    hasTemplate(templateName) {
        var _a;
        return Boolean((_a = this.templates) === null || _a === void 0 ? void 0 : _a[templateName]);
    }
    getTemplates() {
        const templates = {};
    ...
    removeUnusedSlottedElements() {
        ...
        if (this._renderedSlots) {
            for (let i = 0; i < this.children.length; i++) {
                const child = this.children[i];
                if (((_a = child.dataset) === null || _a === void 0 ? void 0 : _a.generated) && !this._slotNamesAddedDuringRender.includes(child.slot)) {
...
__decorate([
    state(),
    __metadata("design:type", Object)
], MgtTemplatedComponent.prototype, "error", void 0);
