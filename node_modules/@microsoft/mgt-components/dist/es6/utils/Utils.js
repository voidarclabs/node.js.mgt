...
export const getRelativeDisplayDate = (date) => {
    const now = new Date();
    // Today -> 5:23 PM
 ...
 * @returns {string}
 */
export const getDayOfWeekString = (day) => {
    switch (day) {
        case 0:
            return 'Sunday';
        case 1:
 ...
 * @returns {number}
 */
export const getDaysInMonth = (monthNum) => {
    switch (monthNum) {
        case 1:
            return 28;
        case 3:
...
export const sanitizeSummary = (summary) => {
    if (summary) {
        summary = summary === null || summary === void 0 ? void 0 : summary.replace(/<ddd\/>/gi, '...');
        summary = summary === null || summary === void 0 ? void 0 : summary.replace(/<c0>/gi, '<b>');
        summary = summary === null || summary === void 0 ? void 0 : summary.replace(/<\/c0>/gi, '</b>');
    }
    return summary;
};
...
export const trimFileExtension = (fileName) => {
    return fileName === null || fileName === void 0 ? void 0 : fileName.replace(/\.[^/.]+$/, '');
};
/**
 ...
 * @returns
 */
export const getNameFromUrl = (webUrl) => {
 ...
 * @returns number
 */
export const getResponseInvalidationTime = (currentInvalidationPeriod) => {
    return (currentInvalidationPeriod ||
