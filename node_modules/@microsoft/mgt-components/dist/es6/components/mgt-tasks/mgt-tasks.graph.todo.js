 ...
 * @memberof BetaGraph
 */
export const addTodoTask = (graph, newTask) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof BetaGraph
 */
export const getAllMyTodoGroups = (graph) => __awaiter(void 0, void 0, void 0, function* () {
    const groups = (yield graph
        .api('/me/outlook/taskGroups')
        .header('Cache-Control', 'no-store')
        .middlewareOptions(prepScopes('Tasks.Read'))
        .get());
    return groups === null || groups === void 0 ? void 0 : groups.value;
});
/**
 ...
 * @memberof BetaGraph
 */
export const getAllTodoTasksForFolder = (graph, folderId) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof BetaGraph
 */
export const getFoldersForTodoGroup = (graph, groupId) => __awaiter(void 0, void 0, void 0, function* () {
    const folders = (yield graph
        .api(`/me/outlook/taskGroups/${groupId}/taskFolders`)
        .header('Cache-Control', 'no-store')
        .middlewareOptions(prepScopes('Tasks.Read'))
        .get());
    return folders === null || folders === void 0 ? void 0 : folders.value;
});
/**
 ...
 * @memberof BetaGraph
 */
export const getSingleTodoGroup = (graph, groupId) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield graph
 ...
 * @memberof BetaGraph
 */
export const removeTodoTask = (graph, taskId, eTag) => __awaiter(void 0, void 0, void 0, function* () {
    yield graph
 ...
 * @memberof BetaGraph
 */
export const setTodoTaskComplete = (graph, taskId, eTag) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof BetaGraph
 */
export const setTodoTaskIncomplete = (graph, taskId, eTag) => __awaiter(void 0, void 0, void 0, function* () {
    return yield setTodoTaskDetails(graph, taskId, {
        isReminderOn: true,
        status: 'notStarted'
    }, eTag);
 ...
 * @memberof BetaGraph
 */
export const setTodoTaskDetails = (graph, taskId, task, eTag) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield graph
        .api(`/me/outlook/tasks/${taskId}`)
        .header('Cache-Control', 'no-store')
        .header('If-Match', eTag)
