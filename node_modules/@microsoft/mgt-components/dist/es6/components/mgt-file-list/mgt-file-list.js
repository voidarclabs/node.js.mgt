...
import { arraysAreEqual, Providers, ProviderState, customElement, mgtHtml, MgtTemplatedComponent } from '@microsoft/mgt-element';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.files) {
                ...
                if (this.fileExtensions && this.fileExtensions !== null) {
                    ...
                    if ((_a = this.pageIterator) === null || _a === void 0 ? void 0 : _a.value) {
