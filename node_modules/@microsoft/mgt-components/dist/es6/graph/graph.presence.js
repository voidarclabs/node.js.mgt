 ...
 * @memberof BetaGraph
 */
export const getUserPresence = (graph, userId) => __awaiter(void 0, void 0, void 0, function* () {
    let cache;
    ...
    const result = (yield graph
        ...
        .get());
    if (getIsPresenceCacheEnabled()) {
        yield cache.putValue(userId || 'me', { presence: JSON.stringify(result) });
    }
    return result;
});
/**
 ...
 * @memberof BetaGraph
 */
export const getUsersPresenceByPeople = (graph, people) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (peoplePresenceToQuery.length > 0) {
            ...
            for (const r of presenceResult.value) {
                ...
                if (getIsPresenceCacheEnabled()) {
                    yield cache.putValue(r.id, { presence: JSON.stringify(r) });
                }
            }
        }
        ...
        try {
            ...
            const response = yield Promise.all(people
                .filter(person => (person === null || person === void 0 ? void 0 : person.id) &&
